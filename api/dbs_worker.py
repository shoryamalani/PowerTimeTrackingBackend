...
def set_up_db_version_1(conn):
    ...
    users_table = create_database.create_table_command("users",[['UUID','int SERIAL'],['name','text'],['email','text'],['date_created','timestamp'],['privacy_status','text'],['last_login','timestamp'],['data','json']],'UUID')
